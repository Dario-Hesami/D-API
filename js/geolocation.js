...
// STEP 1c: Grab the <p> element for outputting geolocation lStatus messages
const lStatus = document.querySelector('#status');
...
function error() {
  ...
  lStatus.textContent = 'Unable to retrieve your location';
}
...
if (!navigator.geolocation) {
  ...
  lStatus.textContent = 'Geolocation is not supported by your browser';
} else {
  // STEP 2c: Geolocation is supported, so let's give the user a useful message
  lStatus.textContent = 'Locating your device...';
